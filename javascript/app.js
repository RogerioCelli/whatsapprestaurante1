...
const whatsappLinkGenerator = (phoneNumber, productTitle, productQuantity, buyerName, buyerPayment, buyerAddress) => `https://api.whatsapp.com/send?phone=${phoneNumber}&text=Olá eu quero: ${productQuantity} ${productTitle} - Entregar para ${buyerName} no endereço: ${buyerAddress} - A forma de pagamento será: ${buyerPayment}`
...
const checkout = phoneNumber => {
  ...
  form.addEventListener('submit', e => {
    ...
    const whatsappUrl = whatsappLinkGenerator(phoneNumber, productTitle, productQuantity, buyerName, buyerPayment, buyerAddress )
